  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="flex gap-3 mb-6 flex-wrap">
        ...
        <Link
          to={`/reports/batch/${id}`}
          className="flex items-center gap-1.5 px-5 py-2.5 bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors"
        >
