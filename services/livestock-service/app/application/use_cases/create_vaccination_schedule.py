...
from app.application.dtos.vaccination_dtos import CreateScheduleRequest
from app.domain.models.health import VaccinationSchedule
from app.domain.repositories.vaccination_repository import AbstractVaccinationScheduleRepository
