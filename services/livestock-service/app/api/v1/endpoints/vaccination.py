...
from app.application.dtos.vaccination_dtos import (
    CreateScheduleRequest,
    RecordVaccinationRequest,
    VaccinationRecordResponse,
    VaccinationScheduleResponse,
)
from app.application.use_cases.create_vaccination_schedule import CreateVaccinationScheduleUseCase
...
from app.infrastructure.database.repositories.vaccination_repository_impl import (
