...
from app.application.dtos.mortality_dtos import (
    MortalityRecordResponse,
    MortalitySummaryResponse,
    RecordMortalityRequest,
)
from app.application.use_cases.get_mortality_history import (
...
from app.infrastructure.database.repositories.mortality_repository_impl import SQLAlchemyMortalityRepository
