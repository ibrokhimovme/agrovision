...
from app.api.v1.endpoints.mortality import router as mortality_router
from app.api.v1.endpoints.vaccination import router as vaccination_router
from app.api.v1.endpoints.weight import router as weight_router
