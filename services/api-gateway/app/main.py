...
Routes and authenticates requests to downstream microservices. BRD §3, SRS §2.
"""
...
app = FastAPI(
    ...
    description="Routes and authenticates requests to downstream microservices. BRD §3, SRS §2.",
    version="0.1.0",
    docs_url="/docs",
    redoc_url="/redoc",
