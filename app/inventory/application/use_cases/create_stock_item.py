...
from app.inventory.application.dtos.inventory_dtos import CreateStockItemRequest, StockItemResponse
from app.inventory.domain.models.inventory import StockItem
from app.inventory.domain.repositories.stock_repository import AbstractStockItemRepository, AbstractWarehouseRepository
