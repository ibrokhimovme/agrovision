...
from app.notifications.core.config import settings
from app.notifications.core.exceptions import register_exception_handlers
from app.notifications.api.v1.router import router as v1_router
